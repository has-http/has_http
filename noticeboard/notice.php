...
<body>
    ...
    <div class="main">
        ...
        <section class="qna-container">
            ...
            <div class="qna-body">
                <p> 모든 학생들은 기한 내 꼭 참여하기 바랍니다. 
                    <br> *기간: 5월 30일(월) ~ 5월 31일(화) 23:59 
                    <br>*방법: 구글 설문조사(반드시 하나고 계정으로 로그인하여 링크 접속) 
                    <br>*주의사항: 모든 영역의 단위수가 졸업 이수 요건을 충족하는지 반드시 확인할 것
                </p>
            </div>
            <hr class="hr-line">
            <h4 class="qna-page">[12기, 13기] 교육과정설명회 질의응답</h1>
                <div class="qna-body">
                    <p>지난 5월에 있었던 교육과정설명회에서 문의주셨던 질문들을 모아 각 학과와 부서에서 답변을 정리하였습니다. 
                        <br> 교육과정에 대한 이해에 도움이 되셨으면 좋겠습니다. 
                        <br> 감사합니다. 
                    </p>
                </div>
            <hr class="hr-line">
